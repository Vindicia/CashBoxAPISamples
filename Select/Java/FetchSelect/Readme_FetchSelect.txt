		FetchSelect Java sample
		-----------------------

Files:

	SEL002FetchSelect.java		- FetchSelect Java class file
	build.sh			- Compiles FetchSelect Java sample
	build.bat			- Compiles FetchSelect Java sample (Windows)
	run.sh				- Runs the FetchSelect Java sample
	run.bat				- Runs the FetchSelect Java sample (Windows)
	Readme_FetchSelect.txt		- This file
